...
export default function Profile() {
  ...
  return (
    <div className="py-20 md:py-24 px-8 md:px-16">

      <div className="flex gap-6 items-center">
        <div className="w-14 h-14 border-2 border-solid border-gray-500 rounded-full flex justify-center items-center bg-blue-400">
